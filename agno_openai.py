...
def initialize_knowledge_base():
    """Initialize the knowledge base with local text files
    Place your text files in the data/txt_files directory
    """
    ...
    if not os.path.exists(txt_dir):
        ...
        # Create a sample file with some Agno documentation
        with open(os.path.join(txt_dir, "agno_docs.txt"), "w") as f:
            f.write(dedent("""
                AI Agents in Agno
                
                Agno is a framework for building AI agents that can interact with various knowledge sources and tools.
                
                Key features of Agno agents:
                ...
                Agents in Agno can be configured with:
    ...
    agent_knowledge = TextKnowledgeBase(
        path="data/txt_files",  # Directory containing your text files
        vector_db=LanceDb(
            uri="tmp/lancedb",
